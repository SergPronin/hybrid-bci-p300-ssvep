...
# Панель настроек: X как доля от половины ширины окна (0 = центр, вправо)
PANEL_X_FRACTION = 0.72
...
PANEL_TB_H = 26
PANEL_LETTER_H = 11
# Смещение подписи влево от центра полей (пиксели, отриц. = влево)
PANEL_LABEL_OFFSET = -125
