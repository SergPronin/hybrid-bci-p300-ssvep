...
### Оверлеи испытуемого снова в GUI (2026-05-21)
- Подключён `ProtocolInstructionOverlay` (P300/калибровка/пауза с номером плитки).
- `SsvepCueOverlay` (стрелки) — raise/activate; PyQt6 `QFont.Weight.Bold`, флаги окон.
